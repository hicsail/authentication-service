...
export class NotificationService {
  ...
  async sendPasswordResetEmail(project: Project, email: string, link: string): Promise<any> {
  ...
  async sendPasswordUpdatedEmail(project: Project, email: string): Promise<any> {
    const response = await this.http
      .post(this.notificationUrl, {
        to: [email],
  ...
  async sendInviteEmail(project: Project, email: string, link: string): Promise<any> {
    const response = await this.http
      .post(this.notificationUrl, {
        to: [email],
